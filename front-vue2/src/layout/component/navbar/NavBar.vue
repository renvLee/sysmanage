  ...
  <div class="nav-container">
    ...
    <div class="right-container">
      ...
      <el-tooltip content="用户身份" placement="bottom">
        <el-tag class="level">{{userInfo && userInfo.user ? userInfo.user.nickname:''}}</el-tag>
      </el-tooltip>
      <el-dropdown v-if="userInfo && userInfo.user " class="dropdown" trigger="click" @command="handleCommand">
        <img class="avatar" :src="userInfo.user.avatar">
  ...
  methods: {
    ...
    consumerLogout() {
      this.$confirm('确定要退出系统?', '提示', {
        ...
        getRequestWithToken('/user/logout',window.localStorage.getItem('token'));
